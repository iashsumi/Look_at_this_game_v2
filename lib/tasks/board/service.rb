...
class Tasks::Board::Service
  ...
  def build_sc_thread(board, node)
    thread_created_at = build_thread_created_at
    ...
    obj =  build_attr(node, thread_created_at)
  ...
  def build_attr(node, thread_created_at)
